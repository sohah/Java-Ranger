...
//    MINIMAL_TIMED_OUT,
    ...
    MUTANT_TIME_OUT,
    TRUE_FOR_MAX_STEPS     //indicates that an invalid there exists is unknown but was run as many test cases as we gave it, and therefore we can interpert this result as no more tightening can exist. Used to be "TRUE_FOR_MAX_STEPS"
}
